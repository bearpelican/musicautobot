# AUTOGENERATED! DO NOT EDIT! File to edit: develop/numpy_encode.ipynb (unless otherwise specified).

__all__ = ['BPB', 'TIMESIG', 'PIANO_RANGE', 'VALTSEP', 'VALTCONT', 'SAMPLE_FREQ', 'NOTE_SIZE', 'DUR_SIZE',
           'MAX_NOTE_DUR', 'midi2npenc', 'npenc2stream', 'file2stream', 'stream2chordarr', 'chordarr2npenc',
