# AUTOGENERATED! DO NOT EDIT! File to edit: develop/config.ipynb (unless otherwise specified).

__all__ = ['default_config', 'music_config', 'musicm_config', 'multitask_config', 'multitaskm_config']
