...
index = {"default_config": "config.ipynb",
         ...
         "get_multitask_model": "model.ipynb",
         "MultiTransformer": "model.ipynb",
         "reset_children": "model.ipynb",
         "TransformerEmbedding": "model.ipynb",
         "MTLinearDecoder": "model.ipynb",
         "MTEncoder": "model.ipynb",
         "MTEncoderBlock": "model.ipynb",
         "MemMultiHeadRelativeAttentionKV": "model.ipynb",
         "MultitrackItem": "transform.ipynb",
         "combine2chordarr": "transform.ipynb",
         "MusicDataBunch": "dataloader.ipynb",
         "partially_apply_vocab": "dataloader.ipynb",
         "MusicItemList": "dataloader.ipynb",
         "is_pos_enc": "dataloader.ipynb",
         "MusicItemProcessor": "dataloader.ipynb",
         "OpenNPFileProcessor": "dataloader.ipynb",
         "Midi2ItemProcessor": "dataloader.ipynb",
         "MusicPreloader": "dataloader.ipynb",
         "batch_position_tfm": "dataloader.ipynb",
         "music_model_learner": "learner.ipynb",
