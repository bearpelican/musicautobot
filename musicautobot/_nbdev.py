...
index = {"default_config": "config.ipynb",
         ...
         "MaskLMTransform": "dataloader.ipynb",
         "S2SFileTfm": "dataloader.ipynb",
         "Midi2MultitrackTfm": "dataloader.ipynb",
         "mtt2tensor": "dataloader.ipynb",
         "melody_chord_tfm": "dataloader.ipynb",
         "M2CTransform": "dataloader.ipynb",
         ...
         "AvgMultiMetric": "learner.ipynb",
         "MTTrainer": "learner.ipynb",
         "multitask_model_learner": "learner.ipynb",
         "MTTTransformer": "model.ipynb",
         "reset_children": "model.ipynb",
         "TransformerEmbedding": "model.ipynb",
         "MTTLinearDecoder": "model.ipynb",
         "MTTEncoder": "model.ipynb",
         "MTTEncoderBlock": "model.ipynb",
         "MemMultiHeadRelativeAttentionKV": "model.ipynb",
         "MultitrackItem": "transform.ipynb",
         "combine2chordarr": "transform.ipynb",
         "split_melodychords": "transform.ipynb",
         ...
         "validate_stream": "transform.ipynb",
         "is_valid_part": "transform.ipynb",
         "BPB": "numpy_encode.ipynb",
         "TIMESIG": "numpy_encode.ipynb",
         "PIANO_RANGE": "numpy_encode.ipynb",
         ...
         "GeLU": "fastai_transformer.ipynb",
         "Swish": "fastai_transformer.ipynb",
         "Activation": "fastai_transformer.ipynb",
         "PositionalEncoding": "fastai_transformer.ipynb",
         "feed_forward": "fastai_transformer.ipynb",
         "init_transformer": "fastai_transformer.ipynb",
         "MultiHeadAttention": "fastai_transformer.ipynb",
         "MultiHeadRelativeAttention": "fastai_transformer.ipynb",
         "LinearDecoder": "fastai_transformer.ipynb",
         "DecoderLayer": "fastai_transformer.ipynb",
         "LockedDropout": "fastai_transformer.ipynb",
         "dropout_mask": "fastai_transformer.ipynb",
         "RNNDropout": "fastai_transformer.ipynb",
         "SequentialRNN": "fastai_transformer.ipynb",
         "TransformerXL": "fastai_transformer.ipynb",
         "tfmer_lm_config": "fastai_transformer.ipynb",
         ...
         "StackedDLs": "stacked_dataloader.ipynb",
         "StackedDL": "stacked_dataloader.ipynb",
