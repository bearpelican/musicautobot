...
parser.add_argument('--d_head', type=int, default=48, help='head dimension')
parser.add_argument('--d_embed', type=int, default=384, help='embedding dimension')
parser.add_argument('--d_model', type=int, default=384, help='model dimension')
parser.add_argument('--d_inner', type=int, default=1024, help='inner dimension in FF')
...
parser.add_argument('--eval_tgt_len', type=int, default=512, help='number of tokens to predict for evaluation')
parser.add_argument('--ext_len', type=int, default=512, help='length of the extended context')
